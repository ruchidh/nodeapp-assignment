...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   $input_part = $_POST["particulars"];
    ...
    //"images" is just a folder name here we will load the file.))
       ...
       $sql = "INSERT INTO invoices (`Financial Year`, `Issued To`,Address,Heading, `Date & time`,Currency,Particulars,`Gross Amount`,`Service Tax`,`Net Amount`)
VALUES ('$fin','$iss','$address','$head','$date','$curr', '$part','$gross' ,'$ser','$net')";
